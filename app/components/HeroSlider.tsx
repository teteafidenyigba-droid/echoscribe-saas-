...
const slides = [
  ...
  {
    specialty: "Échographie · Abdominale & pelvienne",
    ...
    cr: [
      { sec: "RÉSULTATS" },
      { organ: "Foie", desc: "de taille normale, aux contours réguliers, sans lésion focale." },
      { organ: "Vésicule", desc: "alithiasique, à parois fines." },
      { organ: "Reins", desc: "sans anomalie décelable bilatéralement." },
      { sec: "CONCLUSION" },
      { bullet: "Échographie abdominale sans particularité." },
    ],
  },
