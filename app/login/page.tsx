      ...
      <div style={styles.card}>
        ...
        <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <div>
            ...
            <input type="email" required value={email} onChange={(e) => setEmail(e.target.value)} placeholder="dr.dupont@clinique.fr" style={styles.input} />
          </div>
          <div>
        ...
        <p style={styles.footerText}>
          ...
          <Link href="/register" style={{ color: "#38bdf8" }}>Essai gratuit 7 jours</Link>
        </p>
      </div>
    </div>
  );
...
const styles: Record<string, React.CSSProperties> = {
  ...
  logo: {
    ...
    textDecoration: "none", marginBottom: 28, textAlign: "center",
  },
  title: { fontSize: 26, fontWeight: 600, color: "#e2eaf5", marginBottom: 6, textAlign: "center" },
  sub: { fontSize: 14, color: "#7bacc2", fontFamily: "'JetBrains Mono', monospace", marginBottom: 28, textAlign: "center" },
